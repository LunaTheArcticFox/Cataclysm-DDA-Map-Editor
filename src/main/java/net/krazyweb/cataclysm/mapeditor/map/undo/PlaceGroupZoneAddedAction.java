...
public class PlaceGroupZoneAddedAction implements Action {
	...
	public PlaceGroupZoneAddedAction(final CataclysmMap map, final int index, final PlaceGroupZone zone) {
		this.map = map;
		this.index = index;
		this.zone = zone;
	}

	public PlaceGroupZoneAddedAction(final CataclysmMap map, final PlaceGroupZone zone) {
		this(map, -1, zone);
	}
